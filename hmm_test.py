...
model_fn = "baselines/hmm_test_multi_model"
predictions_fn = "baselines/hmm_test_multi_preds"
...
endoReader=dataInterpreter(fn="../multimodalDBM/endomondoHR_proper.json", allowMissingData=True, scaleVals=False, trimmed_workout_length=trimmed_workout_length)
endoReader.buildDataSchema(["sport", "heart_rate"], targetAtt, trainValTestSplit=trainValTestSplit)
batch_size=1
