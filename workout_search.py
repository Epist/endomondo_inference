...
distance_metric = "MAE"
modelFN = "model_states/keras__noAltitude02_49AM_March_16_2017_epoch_25"
...
endoFeatures = ["sport", "heart_rate", "gender", "time_elapsed", "distance", "new_workout", "derived_speed", "userId"]
...
endoReader.buildDataSchema(endoFeatures, targetAtts, trainValTestSplit, zMultiple)
