...
endoFeatures = ["sport", "heart_rate", "gender", "altitude", "time_elapsed", "distance", "new_workout"]
    ...
    for step, (x, y) in enumerate(dataGen):
        ...
        if m.is_training:
            ...
            if step<maxLoggingSteps:
                ...
                inputSeq.extend(data_interp.dataDecoder(inputs)) #Going to want to reformat this for easy use
